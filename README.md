...
| 52 | **docker-android** | Android in docker solution with noVNC supported, video recording and mcp server | TBD | [GitHub](https://github.com/budtmo/docker-android) |
...
| 55 | **wsl2-distro-manager** | GUI for the Windows Subsystem for Linux — and native Linux/macOS VMs on Mac. Install, back up, move and configure distros without CLI flags; AI assistant with tools, MCP server for agents, remote WSL over SSH. | TBD | [GitHub](https://github.com/bostrot/wsl2-distro-manager) |
